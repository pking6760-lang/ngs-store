...
// The NGS monogram: an N with a leaf on its shoulder, on a soft rounded tile.
function SplashMark() {
  return (
    <svg className="splash-mark" viewBox="0 0 64 64" aria-hidden="true">
      ...
      <path
        className="sm-n"
        d="M19 45.5 V21 a1 1 0 0 1 1-1 h4 a1 1 0 0 1 .8.4 L37.8 37 V21 a1 1 0 0 1 1-1 h3.2 a1 1 0 0 1 1 1 v23.5
           a1 1 0 0 1-1 1 h-4 a1 1 0 0 1-.8-.4 L26.2 29 v16.5 a1 1 0 0 1-1 1 H20 a1 1 0 0 1-1-1 z"
      />
      <path className="sm-leaf" d="M43.5 19.2 c1.2 -4.4 5 -6.7 9.3 -6.4 c.4 4.3 -2.2 8.4 -6.6 9.1 c-1 .16 -2 .12 -2.9 -.1 z" />
    </svg>
  );
}
...
export default function AppSplash({ variant = "customer", brand = "NGS", tagline = "" }) {
  ...
  useEffect(() => {
    if (!leaving) return;
    const t = setTimeout(() => setGone(true), 700); // matches the fade-out
    return () => clearTimeout(t);
  }, [leaving]);
