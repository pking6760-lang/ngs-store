...
Goal: when a customer logs in, they get a **6-digit code** in their email and
...
## Step 5 — Make the email show the 6-digit code
...
Customer opens the store → taps 👤 → enters email → **gets a 6-digit code by
