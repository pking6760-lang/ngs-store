-- ════════════════════════════════════════════════════════════════════════════
-- place_order with the referral reward hook (see migration-referral.sql for the
-- referrals table + apply_referral / my_referral_stats RPCs). On the referee's
-- first order both sides get a wallet reward; the referrer's payout is capped by
-- the order's profit so the shop never pays out more than it earned.
-- ════════════════════════════════════════════════════════════════════════════
